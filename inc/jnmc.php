        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Department of Journalism & Mass Communication</h1>
    ...
    <div class="tab-content" id="nav-tabContent">
      ...
      <div class="tab-pane fade show active" id="list-about" role="tabpanel" aria-labelledby="list-about-list">
        <h3 class="text-center">About Department</h3><hr>
            <p align="justify"> 
        The physiotherapy department is a specialized division within a healthcare institution, such as a hospital, clinic, or rehabilitation center, that focuses on: diagnosis, treatment, and management of various physical conditions and injuries. The department is equipped with various tools and equipment necessary for assessment and treatment. This may include exercise machines, therapy tables, ultrasound devices, electrical stimulation devices, heat and cold therapy equipment, and other specialized tools specific to different treatment modalities. Within the physiotherapy department, there may be physiotherapists who have specialized in specific areas of practice, such as sports physiotherapy, pediatric physiotherapy, geriatric physiotherapy, neurorehabilitation, or orthopedic physiotherapy. These specialized professionals bring expertise in treating specific patient populations or conditions. </p>
      </div>
      <!-- About Department Ends -->
        ...
        <div class="row">
          ...
          <h3>Vision</h3>
          <p align="justify"> “To be a pioneering force in promoting holistic health and well-being through evidence-based physiotherapy practices, fostering innovation, education, and collaboration”.</p>
          <h3>Mission</h3>
          <p align="justify">
             1.	Provide exceptional, patient-centered care through personalized physiotherapy interventions tailored to individual needs and goals.<br>
              2. Cultivate a culture of empathy, respect, and integrity among our team members, patients, and community partners.<br>
              3.	Educate and empower individuals to optimize their physical function, prevent injury, and enhance their quality of life through health promotion and education initiatives. <br>
         4.	Collaborate with multidisciplinary teams to deliver comprehensive healthcare solutions that address the diverse needs of our patients and communities.
            </p>
</div>
