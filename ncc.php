...
<!-- Navbar include End -->
 ...
 <div class="container-fluid bg-primary py-5 mb-5 page-header">
    ...
    <a class="list-group-item list-group-item-action active" id="list-class-list" data-bs-toggle="list" href="#list-class" role="tab" aria-controls="list-class">Introduction</a>
      <!-- <a class="list-group-item list-group-item-action" id="list-library-list" data-bs-toggle="list" href="#list-library" role="tab" aria-controls="list-library">Motto & Aims</a> -->
  ...
  <div class="tab-content" id="nav-tabContent">
      ...
      <p>&nbsp;</p>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
                ...
                <p align="justify"><strong>18 February 2021 CTIEMT</strong>, Shahpur campus establishes its NCC unit under 8 Punjab Battalion NCC from NCC headquarters Phagwara The campus got sanction of 54 cadets to be enrolled along with female cadets. Right now we have 35 cadets (SD=26, SW=9). The main objective of NCC to provide military training, the cadets will also learn several other valuable things such as selflessness, honesty, discipline, hard work and ways to build confidence and gain leadership qualities.</p>
      ...
      <div class="row"><p>&nbsp;</p>
        <!-- <h3 class="text-center">Computer Lab</h3><hr> -->
            <div class="col-lg-5 col-md-5 col-sm-5">
        <img class="w-100 h-100" src="img/ncc/ncc.png"></div>
        <div class="col-lg-6 col-md-6 col-sm-6">
            <h6 align="justify">NCC Cadets of CTIEMT, Shahpur attended 10 days NCC Training camp at Punjab technical university, Kapurthala.</h6>
             <br>   <p align="justify">The 10-days camp of the 08 Punjab Battalion National Cadet Corps (NCC) held at Punjab technical university from 8 November 2021 to 17 November 2021. The 200 cadets from various districts are participated in the camp that began on November 8, 2021. The 11 cadets (SW=2,SD=9) of NCC CTIEMT, Shahpur Participated in the Camp. The aims of this NCC camp are developing character, comradeship, discipline, a secular outlook, the spirit of adventure and ideals of selfless service. Also included weapons training, drill, firing, map reading, personality development class, and awareness on lifestyle disease. The camp was inaugurated by battalion Commandant Col. Vishal Uppal, Grp Comm. I.S Bhalla, Col. NS Sidhu, Sub. Kabal singh and Sub. Pooran singh.</p>
 ...
 <!-- Medicare complex starts -->
      ...
      <p>&nbsp;</p>
        ...
        <div class="row">
            ...
            <p align="justify">Mayank sharma NCC cadet of CTIEMT, Shahpur won gold medal in Rifle shooting Competition during NCC Camp at Punjab technical university, Kapurthala.   </p>
           </div>
           <div class="col-lg-2 col-md-2 col-sm-2">
            ...
            <img class="w-75  h-50" src="img/ncc/st2.jpg"><br><br><br><br>
                <p align="justify">
                NCC Cadet Mridul sharma selected for NCC Narmada trekking camp held at Vadodara (Gujrat) from 6 December 2021 to 12 December 2021.
...
<!-- Workshop section starts -->
      ...
      <div class="row"><p>&nbsp;</p>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
        <img class="w-100 h-100" src="img/ncc/akash.jpg"></div>
